                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!-- Form menggunakan metode POST dan action menuju controller Login -->
                                    <form class="user" method="post" action="<?= base_url('/login/auth') ?>">
                                        <!-- Input username menggunakan name="nama" -->
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="nama" aria-describedby="emailHelp"
                                                placeholder="Enter Username..." name="nama">
                                        </div>
                                        <!-- Input password menggunakan name="password" -->
                                        <div class="form-group">
                                        ...
                                        <!-- Tombol "Login" dengan type="submit" -->
